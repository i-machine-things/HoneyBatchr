...
- Never work directly on `main`, `master` . Always create a feature branch first then merge into `master`.
...
update git hub releases on minor version changes of `master`
